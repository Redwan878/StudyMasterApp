...
public final class DialogEditNameBinding implements ViewBinding {
  ...
  private DialogEditNameBinding(@NonNull LinearLayout rootView, @NonNull TextInputEditText etName) {
  ...
  public static DialogEditNameBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogEditNameBinding((LinearLayout) rootView, etName);
    }
