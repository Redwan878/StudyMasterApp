...
public final class ItemNoteBinding implements ViewBinding {
  ...
  private ItemNoteBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvContent,
  ...
  public static ItemNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNoteBinding((MaterialCardView) rootView, tvContent, tvTitle);
    }
